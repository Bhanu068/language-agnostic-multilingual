...
from language_agnostic import MLP, MBart_MLP
...
#     super().__init__()
#     self.model = MBart_MLP()
#     self.model.load_state_dict(torch.load("/home/bhanuv/projects/multilingual_agnostic/checkpoints/mbart/best_val.pt", map_location=torch.device('cpu')))
...
class MBart(nn.Module):
  def __init__(self, config: MBartConfig):
    super().__init__()
    self.model = MBartEncoder.from_pretrained("facebook/mbart-large-50-many-to-many-mmt")
    self.classification_head = MBartClassificationHead(
                                  1024,
                                  1024,
                                  3,
...
if __name__ == "__main__":
    ...
    model = MBart(MBartConfig)
    model.load_state_dict(torch.load("/home/bhanuv/projects/multilingual_agnostic/classification_checkpoints/mbart_0/checkpoint-1580/pytorch_model.bin"))
    ...
    output_dir="/home/bhanuv/projects/multilingual_agnostic/classification_checkpoints/mbart_0",
    learning_rate=2e-5,
